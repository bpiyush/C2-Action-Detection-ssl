...
NUM_GPUS=4
batch_size=16
DATA_DIR=/local-ssd/pbagad/datasets/EPIC-KITCHENS-100/EPIC-KITCHENS/
ANNO_DIR=/local-ssd/pbagad/datasets/EPIC-KITCHENS-100/annotations/
...
out_base_dir=/var/scratch/pbagad/expts/epic-kitchens-ssl/$expt_folder/
# mkdir -p $output_dir
...
python run_net.py \
    ...
    EPICKITCHENS.TEST_LIST /var/scratch/pbagad/projects/C2-Action-Detection-ssl/BMNProposalGenerator/output/ek100/result_proposal-validation.pkl \
